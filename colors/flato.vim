" -----------------------------------------------------------------------------
" File: flato.vim
" Description: Flat colorscheme bluish
" Author: jojoyuji  <jojoyuji@gmail.com>
" Source: https://github.com/jojoyuji/flato
" -----------------------------------------------------------------------------
...
if &background == "dark"
  ...
  "bg generic
	let s:gb.dark0  = ['344860', 235]

  "current line background
	let s:gb.dark1  = ['2d3f53', 237]

  "background for autocomplete
	let s:gb.dark2  = ['566375', 239]

  "TODO
	let s:gb.dark3  = ['29343e', 241]

  "number color
	let s:gb.dark4  = ['5e6f82;', 243]


  "comments
	let s:gb.medium = ['637d9a', 245]

  "more white
	let s:gb.light0 = ['dedfe2', 247]
  "grayish
	let s:gb.light1 = ['a4b0b1', 223]

	let s:gb.light2 = ['956db0', 251]
	let s:gb.light3 = ['bdae93', 253]
	let s:gb.light4 = ['a89984', 255]

  "red
	let s:gb.red    = ['da6d60', 167]
  "kinda yellow
	let s:gb.orange = ['e4c705', 208]
	let s:gb.yellow = ['e4c705', 214]
  "kinda green
	let s:gb.green  = ['57c87f', 142]
	let s:gb.aqua   = ['e68100', 108]
	let s:gb.blue   = ['57c87f', 109]

  "purple
	let s:gb.purple = ['e4c705', 175]
else
...
" }}}
" Javascript {{{
call s:HL('javascriptFuncDef', 'yellow')
" }}}
" Vim: {{{
